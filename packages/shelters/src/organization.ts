...
export const organizations: Organization[] = [
  ...
  },
  {
    ...
    contactEmail: 'associacioarpaandorra@gmail.com',
    contactPhone: '376321685',
    website: undefined,
    region: 'alt-urgell',
    province: 'lleida',
    description: `Vetllar pel benestar i protecció d'animals de tota mena i el compliment de la Llei de Protecció d'Animals,fomentant la adopció i tinença responsable d'animals de companyia.A més de controlar i esterilitzar les colònies de gats del carrer. En queda exclòs tot ànim de lucre.`,
    adoptAnimalsURL: 'https://www.facebook.com/profile.php?id=100085098911186',
    animalFocus: 'cats&dogs',
    shelter: undefined,
    municipalityInscription: `la Seu d'Urgell`,
    municipality: `la Seu d'Urgell`,
    isMunicipal: false,
    associativeInscriptionNumber: '57462',
    isActive: true,
    lastUpdate: '2025-01-25T00:00:00.000Z',
    ...
    shelter: [
      {
        ...
        openingHoursURL:
          'https://urbanisme.paeria.cat/sostenibilitat/animals-de-companyia-i-plagues-urbanes/el-refugi-dels-peluts/el-refugi-dels-peluts',
        phone: '973263504',
      },
    ],
  ...
  },
  {
    ...
    contactEmail: 'encarna@albergdanimals.com',
    region: 'baix-ebre',
    province: 'tarragona',
