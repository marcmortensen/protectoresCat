...
export type Province = (typeof PROVINCE_SLUGS)[number];
...
export type Region = (typeof REGION_SLUGS)[number];
...
export type Municipality = (typeof MUNICIPALITY_NAMES)[number];
